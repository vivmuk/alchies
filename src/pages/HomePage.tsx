      ...
      <main className="container mx-auto px-4 py-6">
        <div className="flex justify-between items-center mb-6">
          ...
          <button 
            ...
            className="bg-primary hover:bg-indigo-600 text-white font-semibold py-2 px-4 rounded-2xl transition flex items-center"
          >
        ...
        {status === 'failed' && (
          <div className="bg-red-100 dark:bg-red-900/30 p-4 rounded-2xl border border-red-200 dark:border-red-800">
            <p className="text-red-700 dark:text-red-400">{error}</p>
          </div>
        )}
        
        {status === 'succeeded' && upcomingEvents.length === 0 && (
          <div className="bg-gray-100 dark:bg-dark-card p-8 rounded-2xl text-center border border-gray-200 dark:border-gray-700">
            ...
            <button 
              onClick={() => navigate('/create')}
              className="bg-primary hover:bg-indigo-600 text-white font-semibold py-2 px-6 rounded-2xl transition"
            >
              Create Event
            </button>
          </div>
